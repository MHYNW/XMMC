...
class Simulation:
    ...
    def Xplane(self):
        with xpc.XPlaneConnect() as client:
            ...
            while True:
                ...
                threading.Thread(self.serial(ser)).start()
                '''write to xplane'''
                ...
                controldata3 = [[25, rotary_throt1, rotary_throt2, rotary_throt3, rotary_throt4, 0, 0, 0,
                                 0]]  # it can be index no.35
    ...
    def Motor_Run(self, roll, pitch, yaw):
        ...
        fVel = 60  # Velocity
        fAcc = 40  # Acceleration
        fDec = 40  # Deceleration
        fJerk = 100  # Jerk
